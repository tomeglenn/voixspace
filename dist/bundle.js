...
var MessageComponent = function () {
  ...
  _createClass(MessageComponent, [{
    ...
    key: 'addSlide',
    value: function addSlide(n, totalMessages, message, checked, isLast) {
      ...
      count.textContent = 'Message ' + n + ' of ' + totalMessages + ' - written ' + (0, _moment2.default)(message.date).fromNow();
...
function getMessage() {
  return _axios2.default.get(ENDPOINTS.MESSAGE);
}

function postMessage(message) {
  return _axios2.default.post(ENDPOINTS.MESSAGE, {
    message: message
  });
}
